...
const footer = () => {
    return (
        // <div id="footer">
        //     <div id="footer_icon">
        //         <img id="fb_icon" alt='img' src='../../assets/img/fb.png'></img>
        //         <img id="ins_icon" alt='img' src="/public/img/ins.png"></img>
        //         <img id="yt_icon" alt='img' src="/public/img/img/yt.png"></img>
        //     </div>
        ...
        <div className='footer'>
            <div className='firstField'>
                <div className='imgfield'>
                    <img src={require('../../assets/img/fb.png')} alt='img'/>
                    <img src={require('../../assets/img/ins.png')} alt='img'/>
                    <img src={require('../../assets/img/yt.png')} alt='img'/>
                </div>
